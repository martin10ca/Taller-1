...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. (TALLER 1) Buscar nacionalidad de un atleta");
	...
	private void ejecutarBusquedaNacionalidad()
	{
		System.out.println("\n" + "(TALLER 1) Busqueda de atletas segun nacionalidad" + "\n");
		String nombre= input(">Ingrese el nombre del atleta");
		String retorno= calculadora.busquedaNacionalidad(nombre);
		System.out.println("\n\t>"+nombre +" representa al siguiente país:" + retorno + ".");
	}
